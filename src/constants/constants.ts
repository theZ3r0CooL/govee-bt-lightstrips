...
export const H617A_MODEL = "H617A"; // RGB Bluetooth + WiFi 32.8 ft. LED Strip

export const MODELS = [H6160_MODEL, H617A_MODEL];
...
export const KEEP_ALIVE_PACKET = "aa010000000000000000000000000000000000ab"; // Packet sent every interval to keep connection alive
